...
export const pokemonEvolutions: PokemonEvolutions = {
  ...
  [SpeciesId.KIDLING]: [ new SpeciesEvolution(SpeciesId.PYROAT, 16, null, null) ],
  [SpeciesId.PYROAT]: [ new SpeciesEvolution(SpeciesId.FLAIREES, 32, null, null) ],
  [SpeciesId.AGUADE]: [ new SpeciesEvolution(SpeciesId.IGUADIUM, 16, null, null) ],
  [SpeciesId.IGUADIUM]: [ new SpeciesEvolution(SpeciesId.AGUANAUT, 32, null, null) ],
  [SpeciesId.HARPEE]: [ new SpeciesEvolution(SpeciesId.AQUILOR, 16, null, null) ],
  [SpeciesId.AQUILOR]: [ new SpeciesEvolution(SpeciesId.WARQUILA, 32, null, null) ],
  [SpeciesId.CAPIG]: [ new SpeciesEvolution(SpeciesId.CAPABARA, 16, null, null) ],
  [SpeciesId.CUBZERO]: [ new SpeciesEvolution(SpeciesId.AVALYNX, 16, null, null) ],
  [SpeciesId.FAWNING]: [ new SpeciesEvolution(SpeciesId.LLAMARSH, 16, null, null) ],
  [SpeciesId.LLAMARSH]: [ new SpeciesEvolution(SpeciesId.BUCKSTON, 32, null, null) ],
  [SpeciesId.PENGLIFF]: [ new SpeciesEvolution(SpeciesId.PENGLACIER, 16, null, null) ],
  [SpeciesId.BLUFFIN]: [ new SpeciesEvolution(SpeciesId.BURRMUDAIL, 16, null, null) ],
  [SpeciesId.KOBLIN]: [ new SpeciesEvolution(SpeciesId.KOBERUS, 16, null, null) ],
  [SpeciesId.KOBERUS]: [ new SpeciesEvolution(SpeciesId.KOBALT, 32, null, null) ],
  [SpeciesId.PEBBLOSA]: [ new SpeciesEvolution(SpeciesId.TERRATETRA, 16, null, null) ],
  [SpeciesId.TERRATETRA]: [ new SpeciesEvolution(SpeciesId.GIGAARD, 32, null, null) ],
  [SpeciesId.SNOME]: [ new SpeciesEvolution(SpeciesId.SNOGRE, 16, null, null) ],
  [SpeciesId.TAOMARIN]: [ new SpeciesEvolution(SpeciesId.ORANGUTAO, 16, null, null) ],
  [SpeciesId.CARAGRUB]: [ new SpeciesEvolution(SpeciesId.CARANOX, 16, null, null) ],
  [SpeciesId.CARANOX]: [ new SpeciesEvolution(SpeciesId.CARAJOULE, 32, null, null) ],
  [SpeciesId.MUSBURRY]: [ new SpeciesEvolution(SpeciesId.MUSBUSHEL, 16, null, null) ],
  [SpeciesId.GROWMEO]: [ new SpeciesEvolution(SpeciesId.MONTEGREW, 16, null, null) ],
  [SpeciesId.TULIEP]: [ new SpeciesEvolution(SpeciesId.CAPULILLY, 16, null, null) ],
  [SpeciesId.KERTRUFFLE]: [ new SpeciesEvolution(SpeciesId.MOSSHROOM, 16, null, null) ],
  [SpeciesId.MOSSHROOM]: [ new SpeciesEvolution(SpeciesId.LUMISHROOM, 32, null, null) ],
  [SpeciesId.ROCANO]: [ new SpeciesEvolution(SpeciesId.VOLCAROC, 16, null, null) ],
  [SpeciesId.VOLCAROC]: [ new SpeciesEvolution(SpeciesId.VOLCOALDER, 32, null, null) ],
  [SpeciesId.POUNTHER]: [ new SpeciesEvolution(SpeciesId.JAGUILE, 16, null, null) ],
  [SpeciesId.NEUREKA]: [ new SpeciesEvolution(SpeciesId.CEREBRULB, 16, null, null) ],
  [SpeciesId.PEPPIT]: [ new SpeciesEvolution(SpeciesId.HOPPANERO, 16, null, null) ],
  [SpeciesId.HOPPANERO]: [ new SpeciesEvolution(SpeciesId.SCOVALOPE, 32, null, null) ],
  [SpeciesId.PAWTER]: [ new SpeciesEvolution(SpeciesId.HURRICANINE, 16, null, null) ],
  [SpeciesId.SKULLARVA]: [ new SpeciesEvolution(SpeciesId.MASKOON, 16, null, null) ],
  [SpeciesId.MASKOON]: [ new SpeciesEvolution(SpeciesId.MORTASQUE, 32, null, null) ],
  [SpeciesId.VECTOL]: [ new SpeciesEvolution(SpeciesId.VECTOL2, 16, null, null) ],
  [SpeciesId.BOUWEE]: [ new SpeciesEvolution(SpeciesId.SCUBUG, 16, null, null) ],
  [SpeciesId.TOTTER]: [ new SpeciesEvolution(SpeciesId.CASCOTTA, 16, null, null) ],
  [SpeciesId.CASCOTTA]: [ new SpeciesEvolution(SpeciesId.LUTRAJET, 32, null, null) ],
  [SpeciesId.ALPINT]: [ new SpeciesEvolution(SpeciesId.FORUSK, 16, null, null) ],
  [SpeciesId.PLATYPOW]: [ new SpeciesEvolution(SpeciesId.PLATIKHAO, 16, null, null) ],
  [SpeciesId.CUPPY]: [ new SpeciesEvolution(SpeciesId.FETTLEKISH, 16, null, null) ],
  [SpeciesId.PSYBEX]: [ new SpeciesEvolution(SpeciesId.GNURU, 16, null, null) ],
  [SpeciesId.FLOWGER]: [ new SpeciesEvolution(SpeciesId.BULLOTUS, 16, null, null) ],
  [SpeciesId.CRALIBER]: [ new SpeciesEvolution(SpeciesId.CRAWGLOCK, 16, null, null) ],
  [SpeciesId.LEAFISH]: [ new SpeciesEvolution(SpeciesId.CHLOROFIN, 16, null, null) ],
  [SpeciesId.QUIBBLE]: [ new SpeciesEvolution(SpeciesId.FOWATTLE, 16, null, null) ],
  [SpeciesId.FOWATTLE]: [ new SpeciesEvolution(SpeciesId.TURKISTADOR, 32, null, null) ],
  [SpeciesId.SEDIRROT]: [ new SpeciesEvolution(SpeciesId.CONDESA, 16, null, null) ],
  [SpeciesId.CARDINITE]: [ new SpeciesEvolution(SpeciesId.CHARDINAL, 16, null, null) ],
  [SpeciesId.PHLASK]: [ new SpeciesEvolution(SpeciesId.NOXIAL, 16, null, null) ],
  [SpeciesId.NOXIAL]: [ new SpeciesEvolution(SpeciesId.FUMIGHAST, 32, null, null) ],
  [SpeciesId.ATOMITE]: [ new SpeciesEvolution(SpeciesId.ORBATOM, 16, null, null) ],
  [SpeciesId.SQUINK]: [ new SpeciesEvolution(SpeciesId.SQUIDRIFT, 16, null, null) ],
  [SpeciesId.CHELONITE]: [ new SpeciesEvolution(SpeciesId.GALAXAGOS, 16, null, null) ],
  [SpeciesId.MINARAC]: [ new SpeciesEvolution(SpeciesId.TRENCHULA, 16, null, null) ],
  [SpeciesId.POTTLE]: [ new SpeciesEvolution(SpeciesId.TRIKOTTA, 16, null, null) ],
  [SpeciesId.TRIKOTTA]: [ new SpeciesEvolution(SpeciesId.TERRORCOTTA, 32, null, null) ],
  [SpeciesId.PUEBLANT]: [ new SpeciesEvolution(SpeciesId.CAHOKISECT, 16, null, null) ],
  [SpeciesId.COBRASKET]: [ new SpeciesEvolution(SpeciesId.CHARMBRA, 16, null, null) ],
  [SpeciesId.CAIRUP]: [ new SpeciesEvolution(SpeciesId.KAIROGLYPH, 16, null, null) ],
  [SpeciesId.NECRONITE]: [ new SpeciesEvolution(SpeciesId.GRAVOLLUM, 16, null, null) ],
  [SpeciesId.DILOWEED]: [ new SpeciesEvolution(SpeciesId.PANGOLASH, 16, null, null) ],
  [SpeciesId.IGNISHELL]: [ new SpeciesEvolution(SpeciesId.SHELOSENE, 16, null, null) ],
  [SpeciesId.SHELOSENE]: [ new SpeciesEvolution(SpeciesId.FLARRAPIN, 16, null, null) ],
  [SpeciesId.DESOULA]: [ new SpeciesEvolution(SpeciesId.NECROW, 16, null, null) ],
  [SpeciesId.NECROW]: [ new SpeciesEvolution(SpeciesId.VULTERGYST, 32, null, null) ],
  [SpeciesId.DINKYWINK]: [ new SpeciesEvolution(SpeciesId.DUNKYWUNKR, 16, null, null) ],
  [SpeciesId.CALPHITE]: [ new SpeciesEvolution(SpeciesId.INDROLITH, 16, null, null) ],
  [SpeciesId.LONELEAF]: [ new SpeciesEvolution(SpeciesId.FORTHORN, 16, null, null) ],
  [SpeciesId.COLTERGEIST]: [ new SpeciesEvolution(SpeciesId.FANTASMARE, 16, null, null) ],
  [SpeciesId.CHIHAHA]: [ new SpeciesEvolution(SpeciesId.HOWLEQUIN, 16, null, null) ],
  [SpeciesId.CHEGRIN]: [ new SpeciesEvolution(SpeciesId.CHESHADE, 16, null, null) ],
  [SpeciesId.DOPPOLE]: [ new SpeciesEvolution(SpeciesId.ARTIFISH, 16, null, null) ],
  [SpeciesId.POMPARUNT]: [ new SpeciesEvolution(SpeciesId.POMPAGOON, 16, null, null) ],
  [SpeciesId.POMPAGOON]: [ new SpeciesEvolution(SpeciesId.HYEKUZA, 32, null, null) ],
  [SpeciesId.TOXITO]: [ new SpeciesEvolution(SpeciesId.SANGUITO, 16, null, null) ],
  [SpeciesId.ORETT]: [ new SpeciesEvolution(SpeciesId.ANVELID, 16, null, null) ],
  [SpeciesId.ANVELID]: [ new SpeciesEvolution(SpeciesId.MAGROPLEX, 32, null, null) ],
  [SpeciesId.CHILLOTH]: [ new SpeciesEvolution(SpeciesId.SOAKOTH, 16, null, null) ],
  [SpeciesId.CHAYAN]: [ new SpeciesEvolution(SpeciesId.MACUARRIOR, 16, null, null) ],
  [SpeciesId.MACUARRIOR]: [ new SpeciesEvolution(SpeciesId.OCERUMI, 32, null, null) ],
  [SpeciesId.FORTIFRY]: [ new SpeciesEvolution(SpeciesId.OARWISH, 16, null, null) ],
  [SpeciesId.SLATIC]: [ new SpeciesEvolution(SpeciesId.TELSION, 16, null, null) ],
  [SpeciesId.TELSION]: [ new SpeciesEvolution(SpeciesId.CHAMELEOHM, 32, null, null) ],
  [SpeciesId.GLAUQUA]: [ new SpeciesEvolution(SpeciesId.HYDRANTICUS, 16, null, null) ],
  [SpeciesId.LINTLE]: [ new SpeciesEvolution(SpeciesId.SILKINDER, 16, null, null) ],
  [SpeciesId.SILKINDER]: [ new SpeciesEvolution(SpeciesId.PARAMOTH, 32, null, null) ],
  [SpeciesId.PARAPY]: [ new SpeciesEvolution(SpeciesId.MAWASITE, 16, null, null) ],
  [SpeciesId.CHIMPOCA]: [ new SpeciesEvolution(SpeciesId.SIMAYAN, 16, null, null) ],
  [SpeciesId.SIMAYAN]: [ new SpeciesEvolution(SpeciesId.MONKEZUMA, 32, null, null) ],
  [SpeciesId.ENIGMITE]: [ new SpeciesEvolution(SpeciesId.ENIGMANTIS, 16, null, null) ],
  [SpeciesId.ARJIBI]: [ new SpeciesEvolution(SpeciesId.ROYJIBIV, 16, null, null) ],
  [SpeciesId.BARRACUTE]: [ new SpeciesEvolution(SpeciesId.JAWGODON, 16, null, null) ],
  [SpeciesId.DROSIRE]: [ new SpeciesEvolution(SpeciesId.SUNDUKE, 16, null, null) ],
  [SpeciesId.WISPERN]: [ new SpeciesEvolution(SpeciesId.PHANTERN, 16, null, null) ],
  [SpeciesId.GLOCTO]: [ new SpeciesEvolution(SpeciesId.LAVOON, 16, null, null) ],
  [SpeciesId.GILLA]: [ new SpeciesEvolution(SpeciesId.HORNIZARD, 16, null, null) ],
  [SpeciesId.HORNIZARD]: [ new SpeciesEvolution(SpeciesId.ANKILLOSORE, 32, null, null) ],
  [SpeciesId.BAZILISK]: [ new SpeciesEvolution(SpeciesId.ORNITHERB, 16, null, null) ],
  [SpeciesId.ORNITHERB]: [ new SpeciesEvolution(SpeciesId.DILOPHLORA, 32, null, null) ],
  [SpeciesId.ICETOPE]: [ new SpeciesEvolution(SpeciesId.CHILLNOBYL, 16, null, null) ],
  [SpeciesId.WENDINGO]: [ new SpeciesEvolution(SpeciesId.CARNIBAL, 16, null, null) ],
  [SpeciesId.LUCHITO]: [ new SpeciesEvolution(SpeciesId.ELUCHADON, 16, null, null) ],
  [SpeciesId.GROLEM]: [ new SpeciesEvolution(SpeciesId.COMOSSUS, 16, null, null) ],
  [SpeciesId.LARVYN]: [ new SpeciesEvolution(SpeciesId.DRACOON, 16, null, null) ],
  [SpeciesId.DRACOON]: [ new SpeciesEvolution(SpeciesId.BASILECT, 32, null, null) ],
  [SpeciesId.CARBITE]: [ new SpeciesEvolution(SpeciesId.PRESSAUR, 16, null, null) ],
  [SpeciesId.PRESSAUR]: [ new SpeciesEvolution(SpeciesId.DIAMAT, 32, null, null) ],
  [SpeciesId.QUECKO]: [ new SpeciesEvolution(SpeciesId.TOZECKO, 16, null, null) ],
  [SpeciesId.CRAKLING]: [ new SpeciesEvolution(SpeciesId.FUELONG, 16, null, null) ],
  [SpeciesId.DRAGGAR]: [ new SpeciesEvolution(SpeciesId.RAGNAROW, 16, null, null) ],
};
